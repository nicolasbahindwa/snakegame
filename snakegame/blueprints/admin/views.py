...
from snakegame.blueprints.admin.models import Dashboard
from snakegame.blueprints.user.decorators import role_required
from snakegame.blueprints.user.models import User
from snakegame.blueprints.billing.decorators import handle_stripe_exceptions
from snakegame.blueprints.billing.models.coupon import Coupon
from snakegame.blueprints.billing.models.subscription import Subscription
from snakegame.blueprints.billing.models.invoice import Invoice
 
from snakegame.blueprints.admin.forms import (
    SearchForm,
    BulkDeleteForm,
    UserForm,
...
def users_bulk_delete():
    ...
    if form.validate_on_submit():
        ...
        from snakegame.blueprints.billing.tasks import delete_users
...
def coupons_bulk_delete():
    ...
    if form.validate_on_submit():
        ...
        # Prevent circular imports.
        from snakegame.blueprints.billing.tasks import delete_coupons

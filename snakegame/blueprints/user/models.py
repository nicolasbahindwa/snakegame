...
from snakegame.blueprints.billing.models.credit_card import CreditCard
...
from snakegame.blueprints.bet.models.bet import Bet
from snakegame.extensions import db
...
class User(UserMixin, ResourceMixin, db.Model):
    ...
    invoices = db.relationship(Invoice, backref='invoices',
                               passive_deletes=True)
    bets = db.relationship(Bet, backref='bets',
                           passive_deletes=True)
    ...
    secret_phrase = db.Column(db.String(128), index=True)
    ...
    def initialize_password_reset(cls, identity):
        ...
        from snakegame.blueprints.user.tasks import (

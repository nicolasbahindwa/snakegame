...
from snakegame.blueprints.admin import admin
from snakegame.blueprints.page import page
from snakegame.blueprints.contact import contact
from snakegame.blueprints.user import user
from snakegame.blueprints.billing import billing
from snakegame.blueprints.billing import stripe_webhook
from snakegame.blueprints.user.models import User
from snakegame.blueprints.bet import bet
from snakegame.blueprints.billing.template_processors import (
  format_currency,
  current_year
)
from snakegame.extensions import (
    debug_toolbar,
    mail,
    csrf,
    db,
...
CELERY_TASK_LIST = [
    'snakegame.blueprints.contact.tasks',
    'snakegame.blueprints.user.tasks',
    'snakegame.blueprints.billing.tasks',
]
